...
negexp1 = _Function(function=_negexp,name = 'negexp',arity=1)
square1 = _Function(function=_square,name='square',arity=1)
tanh1 = _Function(function=_tanh,name='tanh',arity = 1)
round1 = _Function(function=np.round,name='round',arity=1)
