...
def lhs_sample_in_2D(num_samples = 256,v_range = [-10.,10.],method = 'lhs',seed = 42):
    target_vec = np.array(create_initial_sample(dim = 2,n = num_samples,lower_bound=v_range[0],upper_bound=v_range[1],sample_type=method,seed = seed))
    np.save('./target_vec.npy',target_vec)
