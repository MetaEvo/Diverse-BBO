...
def get_config(args=None):
    ...
    # Common config
    parser.add_argument('--problem', default='Diverse-BBO', choices=['Diverse-BBO'],
    ...
    parser.add_argument('--all_instances', type=bool, default=False, help='get all instances of sets')
    ...
    parser.add_argument('--train_mode', default='multi',type = str, choices = ['single', 'multi'])
