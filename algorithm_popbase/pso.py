...
class PSO(Optimizer):
    ...
    def _collect(self, fitness, y=None):
        ...
        # save space 
        result_simple = {}
        result_simple['best_so_far_x'] =  results['best_so_far_x']
        result_simple['best_so_far_y'] = results['best_so_far_y']
        result_simple['_n_generations'] = self._n_generations
        result_simple['log_points'] = self.records  # 将记录添加到结果中
        # return result_simple
        return {'log_points' : self.records,
            'best_so_far_y': result_simple['best_so_far_y']}
    ...
    def optimize(self, fitness_function=None, args=None):
        ...
        # 对于BBOB或者MABBOB这种会早停的，继续填充records
